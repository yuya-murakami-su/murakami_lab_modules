"""Matplotlib plotting helpers for research figures."""
...
class Plotter:
    """Convenience wrapper around a Matplotlib figure and axes.

    The class provides consistent styling, deterministic series cycling, parity
    plot support through callbacks, and contour helpers with muted colormap
    aliases suitable for scientific figures.

    Use ``series=`` to explicitly control color/marker/style assignment when a
    plot must be independent of call order.
    """
    ...
    def available_colormaps() -> tuple[str, ...]:
        """Return custom colormap aliases provided by this module."""

        return tuple(_COLORMAP_DEFINITIONS)

    @staticmethod
    def get_colormap(cmap: str | object):
        """Resolve a custom alias, Matplotlib colormap name, or colormap object."""
    ...
    def scatter(
        ...
        """Draw a scatter series with optional x/y error bars."""
    ...
    def plot_and_scatter(
        ...
        """Draw a connected marker series with optional x/y error bars."""
    ...
    def contourf(
        ...
        """Draw a filled contour plot and optionally add a colorbar."""
    ...
    def contour(
        ...
        """Draw contour lines and optionally label them."""
    ...
    def remove_plots(self, reset_idx: bool = True):
        """Remove plotted artists from the axes."""
    ...
    def remove_colorbars(self):
        """Remove all colorbars created by this plotter."""
    ...
    def add_details(
        ...
        """Set labels, limits, scales, and legend placement."""
    ...
    def update(self):
        """Redraw the current figure or interactive Tk window."""
    ...
    def save_fig(self, save_path: str | Path):
        """Save the figure, defaulting to PNG when no suffix is supplied."""
    ...
    def close(self):
        """Close the figure and any associated Tk window."""
